...
from cosmos_predict2._src.predict2.action.configs.action_conditioned.conditioner import (
    register_conditioner as register_action_conditioner,
)
...
from cosmos_predict2._src.predict2.interactive.configs.callbacks import register_callbacks
...
def make_config() -> Config:
    ...
    import_all_modules_from_package("cosmos_predict2._src.predict2.interactive.configs.experiment", reload=True)
    return c
